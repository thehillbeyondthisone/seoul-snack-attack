...
export class Soundtrack {
  constructor(urls, { volume = 0.42 } = {}) {
    ...
    if (localStorage.getItem('seoul-delivery-audio-settings-v2') !== '1' && this.audio.volume === 0) {
  ...
  setVolume(value) {
    ...
    localStorage.setItem('seoul-delivery-music', String(this.audio.volume));
  }
  ...
  async setTrack(index, { autoplay = false } = {}) {
    ...
    localStorage.setItem('seoul-delivery-track', String(this.index));
    this.audio.pause();
